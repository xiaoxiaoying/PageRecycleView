...
import com.xiaoxiaoyin.checkbox.R;
import com.xiaoxiaoyin.checkbox.util.CompatUtils;
...
public class CheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        int tickColor = ta.getColor(R.styleable.CheckBox_color_tick, COLOR_TICK);
        mAnimDuration = ta.getInt(R.styleable.CheckBox_duration, DEF_ANIM_DURATION);
        mFloorColor = ta.getColor(R.styleable.CheckBox_color_unchecked_stroke, COLOR_FLOOR_UNCHECKED);
        mCheckedColor = ta.getColor(R.styleable.CheckBox_color_checked, COLOR_CHECKED);
        mUnCheckedColor = ta.getColor(R.styleable.CheckBox_color_unchecked, COLOR_UNCHECKED);
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.CheckBox_stroke_width,
                CompatUtils.dp2px(getContext(), 0));
        shape = ta.getInt(R.styleable.CheckBox_shape, 0);
        ta.recycle();
    ...
    private void drawBorder(Canvas canvas) {
        ...
        if (shape == 0x00)
            ...
            canvas.drawRect(mCenterPoint.x - radius, mCenterPoint.y - radius, mCenterPoint.x + radius, mCenterPoint.y + radius, mFloorPaint);
    }
